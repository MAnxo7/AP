...
int main(int argc, char **argv) {
    ...
    cvNamedWindow("Componente VERDE", CV_WINDOW_AUTOSIZE);
    cvShowImage("Componente VERDE", ImgGREEN);
    
    cvWaitKey(0);
    
    cvNamedWindow("Componente ROJO", CV_WINDOW_AUTOSIZE);
    cvShowImage("Componente ROJO", ImgRED);
    ...
    cvDestroyWindow("Componente ROJO");
